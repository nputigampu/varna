        ...
        <Container>
            <Left>
                ...
                <Desc>
                    ...
                    Fashion future. Please sign up for our news letter to
                    receive latest offers and news
                </Desc>
                <SocialContainer>
            ...
            <Right>
                <Title>Contact</Title>
                <ContactItem>
                    <Room style={{ marginRight: "10px" }} /> Rhinstraße 98 ,
                    Frankfurt am Main 60308, Germany
                </ContactItem>
                <ContactItem>
                    <Phone style={{ marginRight: "10px" }} /> +49 234 56 78 90
                </ContactItem>
                <ContactItem>
